    ...
    return (
        ...
        <Card
            sx={{
                ...
                borderRadius: '20px',
                boxShadow: '0 12px 32px 0 rgba(31, 38, 135, 0.5)',
                border: '1px solid rgba(255, 255, 255, 0.3)',
                color: '#ffffffe0',
                transition: 'transform 0.2s, box-shadow 0.2s',
                '&:hover': {
                    transform: 'translateY(-5px)',
                    boxShadow: '0 16px 40px rgba(31, 38, 135, 0.6)',
                },
            }}
        >
            <CardContent>
                <Box display="flex" alignItems="center" flexDirection={{ xs: 'column', md: 'row' }}>
                    ...
                    <Box display="flex" flexDirection="column" width="100%">
                        <Box display="flex" alignItems="center" marginBottom={2}>
                            ...
                            <Typography variant="h5" component="div" fontWeight="bold" sx={{ ml: 1 }}>
                                {dateTime.toLocaleDateString()} ({monthNames[dateTime.getMonth()] + " " + dateTime.getDate()})
                            </Typography>
                        </Box>

                        <Typography variant="body2" color="text.secondary" sx={{ marginBottom: '8px' }}>
                            The Gregorian calendar is the most widely used civil calendar today, and the AD system was established to mark years since the birth of Jesus Christ.
                        </Typography>

                        <Box display="flex" alignItems="center" marginBottom={2}>
                            <img src={`${process.env.PUBLIC_URL}/nepalflag.png`} width={24} height={24} alt="Nepal Flag" />
                            <Typography variant="h5" component="div" fontWeight="bold" sx={{ ml: 1 }}>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Nepali Date, also known as Nepali Calendar or Bikram Sambat (B.S.), is the official calendar of Nepal.
                        </Typography>
                    </Box>
                </Box>
            </CardContent>
