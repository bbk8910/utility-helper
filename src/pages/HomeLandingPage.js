...
const features = [
    ...
    {id: 4, icon: <AnalyticsIcon style={{fontSize: 40, color: '#ff9800'}}/>, label: 'Growth', onclickUrl: '/growth'},
    {
        id: 4,
    ...
    return (
        <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" p={2}>
            <Link to={onclickUrl} style={{textDecoration: 'none', color: 'inherit'}}>
                <IconButton style={{backgroundColor: '#f5f5f5', padding: 20, borderRadius: '50%'}}>
                    {icon}
                </IconButton>
            ...
            <Box>
                ...
                <Grid container spacing={4} justifyContent="left">
                    {features.map((feature) => (
                        <Grid item key={feature.id}  sm={6} md={3} xs={4}>
